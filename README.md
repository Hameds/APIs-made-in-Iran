...
:free: | [API اطلاعات شهر‌های ایران](https://api.divar.ir/v5/places/cities) | لیست همه شهر‌های ایران(اگر وارد سایت بشین و قسمت Network رو نگاه کنین میتونین در قسمت درج آگهی ببینید به چه url خاضی داره ریکوست زده میشه و استفاده کنین با متد get)
:free: | [API اطلاعات مناطق تهران](https://api.divar.ir/v5/places/cities/1/districts) | لیست منطقه‌های تهران(برای دیدن بقیه شهر‌ها هم کافیه طبق توضیحات بالا شهرتون رو در سایت عوض کنین)

## دسته‌بندی و لیست‌ها
وضعیت قیمت | لینک | موضوع
 | --- |--- | ---
:free: | [API لیست دسته‌بندی دیوار](https://api.divar.ir/v6/categories) | لیست دسته‌بندی‌ها در دیوار
