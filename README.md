...
[API کاوه نگار](https://kavenegar.com/) | کاوه نگار سرویس ارسال و دریافت پیامک را از فراهم کننده های اصلی مخابرات تهیه نموده و آن را در غالب ساختار وب‌سرویس REST و SOAP با رعایت اصول طراحی API پیاده سازی کرده است .
</div>
