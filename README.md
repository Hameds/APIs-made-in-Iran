...
:free: | [API نوبیتکس](https://nobitex.ir/api) | پلتفرم مبادله بیت‌کوین و سایر رمزارزها
...
:free: | [API مسلم صلات](https://apieco.ir/api/muslimsalat-religious-times-prayers/) | سرویس اوقات شرعی براساس موقعیت مکانی
:free: | [API تبدیل تاریخ جلالی](https://apieco.ir/api/date-jalali-conventor/) | سرویس تبدیل تاریخ به جلالی
:free: | [API ساعت جهانی](https://apieco.ir/api/world-clock/) | سرویس دریافت ساعت جهانی
:free: | [API اوقات شرعی](http://prayer.aviny.com/PrayerTimes-WebService.aspx) | سرویس جهت دریافت اوقات شرعی شهرهای ایران
:free: | [API اوقات شرعی](http://prayer.aviny.com/PrayerTimes-WebService.aspx) | سرویس جهت دریافت اوقات شرعی شهرهای ایران
...
وضعیت قیمت | لینک | موضوع
 ...
 :free::moneybag: | [API اطلاعات پرواز لوفت هانزا](https://apieco.ir/api/lufthansa-airlines/) | سرویس اطلاعات هواپیمایی لوفت هانزا
 :free::moneybag: | [API اطلاعات فرودگاه ها](https://apieco.ir/ourairport-api/) | سرویس اطلاعات فرودگاه ها
 :free::moneybag: | [API اطلاعات ترانزیت](https://apieco.ir/api/transitland-api/) | سرویس اطلاعات بار و ترانزیت
...
وضعیت قیمت | لینک | موضوع
 | --- |--- | --- 
 :moneybag:  | [API نرخ ارز لحظه ای](https://apieco.ir/api/finnotech-realtime-currency/) | سرویس جهت دریافت نرخ ارز به صورت لحظه ای(دقت اطلاعات بالا)
 :moneybag:  | [API نرخ ارز روزانه](https://apieco.ir/api/finnotech-daily-currency/) | سرویس جهت دریافت نرخ ارز به صورت روزانه(دقت اطلاعات بالا)
 :moneybag:  | [API نرخ سکه و فلزات گرانبها](https://apieco.ir/api/finnotech-gold-and-currency-markets/) | سرویس جهت دریافت نرخ ارز به صورت روزانه(دقت اطلاعات بالا)
 ...
 :free:  | [API نرخ لحظه ای ارز و طلا و سکه](https://currency.jafari.pw/) | 
 :free:  | [API تبدیل نرخ ارز](https://apieco.ir/api/currency-converter/) | سرویس رایگان تبدیل نرخ های ارز
