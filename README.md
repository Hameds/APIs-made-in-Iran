...
وضعیت قیمت | لینک | موضوع
 | --- |--- | ---
 :free: | [API دی‌ان‌اس‌ لب](https://dnslab.ir/api) | وب سرویس اطلاعات آی پی ، بررسی پینگ ، بررسی باز بودن Port یک آی پی یا آدرس عمومی ، پرس و جو رکورد های DNS از قیبل (A,NS,CNAME,MX,SOA,TXT)
