...
:question: | [API پایگاه اطلاع رسانی دفتر حفظ و نشر آثار حضرت آیت الله خامنه ای ](http://web.archive.org/web/20190330102737/http://farsi.khamenei.ir/help-content?id=21881) | خروجی محتوا وب سایت پایگاه اطلاع رسانی دفتر حفظ و نشر آثار حضرت آیت الله خامنه ای- اکنون غیرفعال است.
...
وضعیت قیمت | لینک | موضوع
 ...
 :question: | [API کامنتوم](http://commentum.ir/) | ایده‌کاوی در متن‌های کوتاه فارسی- اکنون غیرفعال است.
 ...
 :question: | [API زال](https://miras-tech.github.io/zaal/) | سرویس پردازش زبان طبیعی (NLP) زال - اکنون غیرفعال است.
## پردازش گفتار
وضعیت قیمت | لینک | موضوع
 | --- |--- | ---
 :free::moneybag: | [API فارس‌آوا](https://panel.amerandish.com)| [مستندات](https://bump.sh/doc/farsava) تبدیل گفتار به متن
 :money: | [API سرویس IoType](https://www.iotype.com/api) | سرویس تبدیل گفتار به نوشتار
...
وضعیت قیمت | لینک | موضوع
 ...
 :moneybag:  | [نرخ 44 ارز دنیا - بدون محدودیت زمان و در خواست](https://api.sunnyweb.ir/) | سرویس غیررایگان جهت دریافت نرخ ارز و طلا و سکه
...
وضعیت قیمت | لینک | موضوع
 ...
 :question: | [API پارسی جو](http://csi.parsijoo.ir/#?q=page2) | سرویس نقشه وب سایت ایرانی پارسپی جو:free::moneybag: | [API سیدار مپ](http://api.cedarmaps.com/docs/) | سرویس نقشه ایرانی با قابلیت‌هایی نظیر تبدیل نقطه جغرافیایی به آدرس و مکان یاب و جانمایی روی نقشه
